      ...
      <FormGroup>
          ...
          <div className="main-category">
            ...
            <ul className="multi-options-grid">
              ...
              <li><FormControlLabel control={<Checkbox size="small" checked={data.diner} onChange={handleCheckboxChange('diner')}/>} label="diner"/>
        {data.diner && (<TextField value={data.dinerDescription} onChange={e => updateFields({ dinerDescription: e.target.value })} label="diner distance" /> )}</li>
              ...
              <li><FormControlLabel control={<Checkbox size="small" checked={data.livingRoom} onChange={handleCheckboxChange('livingRoom')}/>} label="living room"/>
        {data.livingRoom && (<TextField value={data.livingRoomDescription} onChange={e => updateFields({ livingRoomDescription: e.target.value })} label="living room details" /> )}</li>
          ...
          <div className="main-category">
            ...
            <ul>
              <li><TextField id="outlined-basic" size="small" type="number" label="Area of the house in m2" variant="standard" value={data.areaOfTheHouseInM2} onChange={e => updateFields({ areaOfTheHouseInM2: e.target.value })} /></li>
              <li><TextField id="outlined-basic" size="small" type="number" label="Surrounding area in m2" variant="standard" value={data.surroundingAreaInM2} onChange={e => updateFields({ surroundingAreaInM2: e.target.value })} /></li>
              <li><TextField id="outlined-basic" size="small" type="number" label="Number of floors to the ground" variant="standard" value={data.numOfFloorsToGround} onChange={e => updateFields({ numOfFloorsToGround: e.target.value })} /></li>
              <li><TextField id="outlined-basic" size="small" type="number" label="Year of built" variant="standard" value={data.yearOfBuilt} onChange={e => updateFields({ yearOfBuilt: e.target.value })} /></li>
            </ul>
          </div>
